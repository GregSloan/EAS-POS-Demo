...
variable "automate_token" {
  default = ""
  description = "this token will be added to chec automate as a reporter token"
}

/////////////////////////////////////
// POS Application Config
variable "reg_app_package" {
  default = "retail-register-app"
  description = "Habitat app package to install on register nodes"
}

variable "reg_app_origin" {
  default = "gsloan-chef"
  description = "origin thta holds the register app package"
}

variable "backoffice_app_package"{
  default = "retail-register-app"
  description = "Habitat app package to install on backoffice nodes"
}

variable "backoffice_app_origin"{
  default = "gsloan-chef"
}

variable "store1_channel" {
  default = "stable"
  description = "channel that nodes in store 1 will watch for application package updates"
}

variable "store2_channel" {
  default = "stable"
}

variable "store3_channel" {
  default = "stable"
}
...
/////////////////////////////////////////////////////
//Effortless Infra and Audit details
variable "config_package" {
